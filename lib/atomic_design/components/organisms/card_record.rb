...
module AtomicDesign
  module Components
    module Organisms # :nodoc:
      class CardRecord < ::AtomicDesign::Components::Base
        # == Slots
        ...
        renders_many :tables, lambda_slots_component_handler(AtomicDesign::Components::Molecules::Table)
        renders_many :buttons, lambda_slots_component_handler(AtomicDesign::Components::Atoms::Button)

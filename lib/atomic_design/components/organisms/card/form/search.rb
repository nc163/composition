...
module AtomicDesign
  module Components
    module Organisms # :nodoc:
      module Card
        module Form
          class Search < ::AtomicDesign::Components::Base
            # == Layout
            default_layout class: 'card'

            # == Slots
            renders_one :head,  AtomicDesign::Components::Molecules::Card::Head
            renders_one :body,  AtomicDesign::Components::Molecules::Card::Body
            renders_one :foot,  AtomicDesign::Components::Molecules::Card::Foot

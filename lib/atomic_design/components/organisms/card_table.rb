...
module AtomicDesign
  module Components
    module Organisms # :nodoc:
      class CardTable < ::AtomicDesign::Components::Base
        # == Slots
        renders_one :card, lambda_slots_component_handler(AtomicDesign::Components::Molecules::Card)
        renders_one :table, lambda_slots_component_handler(AtomicDesign::Components::Molecules::Table)
        renders_one :pagination, lambda_slots_component_handler(AtomicDesign::Components::Atoms::Pagination)

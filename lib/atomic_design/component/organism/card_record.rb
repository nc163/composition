...
module AtomicDesign
  module Component
    module Organism
      class CardRecord < ::AtomicDesign::Component::Base
        # == Slots
        ...
        renders_many :tables, lambda_slots_component_handler(AtomicDesign::Component::Molecule::Table)
        renders_many :buttons, lambda_slots_component_handler(AtomicDesign::Component::Atom::Button)

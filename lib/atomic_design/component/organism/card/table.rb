      ...
      module Organism
        module Card 
          class Table < Component
            ...
            renders_one :table, lambda_slots_component_handler(AtomicDesign::Molecule::Table)
            renders_one :pagination, lambda_slots_component_handler(AtomicDesign::Atom::Pagination)

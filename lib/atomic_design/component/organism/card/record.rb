...
# render Organism::Card::Record.new @user, only: [:name, :email], except: nil
module AtomicDesign
  module Component
      ...
      module Organism
        module Card
          class Record < Component
            ...
            renders_many :fields, lambda_slots_component_handler(AtomicDesign::Molecule::Field)
            renders_many :tables, lambda_slots_component_handler(AtomicDesign::Molecule::Table)
            renders_many :buttons, lambda_slots_component_handler(AtomicDesign::Atom::Button)

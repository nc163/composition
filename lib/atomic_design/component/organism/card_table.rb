...
module AtomicDesign
  module Component
    module Organism
      class CardTable < ::AtomicDesign::Component::Base
        # == Slots
        renders_one :card, lambda_slots_component_handler(AtomicDesign::Component::Molecule::Card)
        renders_one :table, lambda_slots_component_handler(AtomicDesign::Component::Molecule::Table)
        renders_one :pagination, lambda_slots_component_handler(AtomicDesign::Component::Atom::Pagination)

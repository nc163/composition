      ...
      module Organisms
        module Card 
          class Table < Component
            ...
            renders_one :table, lambda_slots_component_handler(AtomicDesign::Molecules::Table)
            renders_one :pagination, lambda_slots_component_handler(AtomicDesign::Atoms::Pagination)
            ...
            def options_for_table
              @options_for_table_headers ||= table_attributes.map { |attribute| [context.human_attribute_name(attribute), {}] }

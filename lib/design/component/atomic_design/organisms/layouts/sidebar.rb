...
module Design
  module Component
    module AtomicDesign
      module Organisms
        module Layouts
          class Sidebar < Organisms::Component
            ...
            renders_one :list, lambda_slots_component_handler(AtomicDesign::Molecules::List)
            renders_many :fields, lambda_slots_component_handler(AtomicDesign::Molecules::Field)
            renders_many :badges, lambda_slots_component_handler(AtomicDesign::Atoms::Badge)

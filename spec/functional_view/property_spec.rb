...
describe FunctionalView::Property do # :nodoc:
  let(:function_class) { FunctionalView::Function }
  ...
  it 'append' do
    ...
    function = function_class.new(type: :helper, name: :test, argv: [], required: false, default: nil, to: :test_method)
  ...
  it 'any?' do
    ...
    property.append(function_class.new(type: :helper, name: :test, argv: [], required: false, default: nil, to: :test_method))
  ...
  it 'pluck' do
    property = described_class.new
    property.append function_class.new(type: :helper, name: :test1, argv: [], required: false, default: nil, to: :test_method)
    property.append function_class.new(type: :action, name: :test2, argv: [], required: false, default: nil, to: :test_method)

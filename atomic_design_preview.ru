...
module AtomicDesignPreview
  class Application < Rails::Application # :nodoc:
    ...
    # Lookbookの設定
    config.autoload_paths += Dir[Rails.root.join('lib/atomic_design_preview')]
    config.view_component.preview_paths = [File.expand_path('lib/atomic_design_preview', __dir__)]

    # https://lookbook.build/guide/config
    # config.view_component.default_preview_layout = "component_preview"
    config.lookbook.project_name = 'AtomicDesignPreview'
